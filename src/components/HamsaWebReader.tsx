...
const DEFAULT_API_URL =
  ...
  "https://fibre-carroll-invalid-seasonal.trycloudflare.com/api";

const DEFAULT_BASE_URL =
  process.env.NEXT_PUBLIC_HAMSA_BASE_URL ||
  "https://fibre-carroll-invalid-seasonal.trycloudflare.com";

const SCRIPT_URL =
  "https://fibre-carroll-invalid-seasonal.trycloudflare.com/webreader.js";
