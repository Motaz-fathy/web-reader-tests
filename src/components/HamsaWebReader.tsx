...
const DEFAULT_API_URL =
  ...
  "https://restored-expensive-wallet-construction.trycloudflare.com/api";

const DEFAULT_BASE_URL =
  process.env.NEXT_PUBLIC_HAMSA_BASE_URL ||
  "https://restored-expensive-wallet-construction.trycloudflare.com";

const SCRIPT_URL =
  "https://restored-expensive-wallet-construction.trycloudflare.com/webreader.js";
